###########################################
# MSCA 37010 3  Programming for Analytics #
# Week 2 Quiz with Solutions              #
###########################################
...
x <- matrix(c(0,6,1,3,5,9), nrow=2, ncol=3, dimnames=list(rows=c("r.1", "r.2"),cols=c("c.1", "c.2", "c.3"))); x
